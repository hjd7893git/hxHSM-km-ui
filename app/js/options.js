...
angular.module('myApp.options', ['ngResource'])
    ...
    .factory('myOptions', function() {
        var optionNames = [
            ...
            {option: 'keyMode', names: [{value: 'RSA-1024', name: 'RSA 1024 Bits'}, {value: 'RSA-1152', name: 'RSA 1152 Bits'}, {value: 'RSA-1408', name: 'RSA 1408 Bits'}, {value: 'RSA-2048', name: 'RSA 2048 Bits'}, {value: 'SM2-256', name: 'SM2 256 Bits'}]},
