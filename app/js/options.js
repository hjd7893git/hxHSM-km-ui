...
angular.module('myApp.options', ['ngResource'])
    ...
    .factory('myOptions', function() {
        var optionNames = [
            ...
            {option: 'keyType', names: [{value: '000', name: 'BMK'}, {value: '001', name: 'PIK'}, {value: '003', name: 'PVK'}, {value: '008', name: 'MAK'}, {value: '00A', name: 'DEK'}, {value: '402', name: 'CVK'}, {value: '00C', name: 'RSA-SK'}]},
