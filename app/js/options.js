...
angular.module('myApp.options', ['ngResource'])
    ...
    .factory('myOptions', function() {
        var optionNames = [
            ...
            { option: 'keyType', names: [
                { value: '000', name: '000(ZMK/BMK)' }, { value: '001', name: '001(ZPK)' }, { value: '002', name: '002(PVK/TPK/TMK/CVK)' },
                { value: '402', name: '402(CVK)' }, { value: '003', name: '003(TAK)' }, { value: '008', name: '008(ZAK)' },
                { value: '109', name: '109(MDK-AC/MDK-ENC/MDK-MAC/KMC)' }, { value: '209', name: '209(MDK-AC/MDK-ENC/MDK-MAC/KMC)' },
                { value: '309', name: '309(MDK-AC/MDK-ENC/MDK-MAC/KMC)' }, { value: '409', name: '409(MDK-AC/MDK-ENC/MDK-MAC/KMC)' },
                { value: '00A', name: '00A(ZEK/SEK/LK/LK2/TK)' }, { value: '00B', name: '00B(TEK)' }, { value: '00C', name: '00C(RSA-SK)' },
                { value: '509', name: '509(MK-DN)' },

                { value: 'RSA', name: 'RSA' },
                { value: 'SM2', name: 'SM2' }
            ]
            },
            { option: 'keySchema', names: [
                { value: 'Y', name: '3DES-192 Bits' }, { value: 'X', name: '3DES-128 Bits' }, { value: 'Z', name: 'DES-64 Bits' }, { value: 'S', name: 'SM4-128 Bits' },

                { value: '256', name: '256-Bits' },
                { value: '1024', name: '1024-Bits' },
                { value: '1152', name: '1152-Bits' },
                { value: '1408', name: '1408-Bits' },
                { value: '2048', name: '2048-Bits' }
            ]
            },
            ...
            {tableId: 'Application', title: '渠道接入管理', keyInfo: 'name',
                controller: function($log, $rootScope, $scope, myServer) {
                    ...
                    $scope.downloaded = function(rec) {
                        var promise2 =myServer.call("zip/"+rec,{},'GET')
